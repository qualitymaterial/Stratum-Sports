...
class PlayerPropSnapshot(Base):
    ...
    outcome_name: Mapped[str] = mapped_column(String(40), nullable=False)
...
Index(
    ...
    PlayerPropSnapshot.event_id,
    PlayerPropSnapshot.market,
    PlayerPropSnapshot.player_name,
    PlayerPropSnapshot.sportsbook_key,
    PlayerPropSnapshot.fetched_at,
)
