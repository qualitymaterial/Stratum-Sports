...
ROLE_PERMISSIONS: dict[str, set[str]] = {
    ADMIN_ROLE_SUPER: {PERMISSION_ADMIN_READ, PERMISSION_USER_TIER_WRITE},
    ADMIN_ROLE_OPS: {PERMISSION_ADMIN_READ, PERMISSION_USER_TIER_WRITE},
    ADMIN_ROLE_SUPPORT: {PERMISSION_ADMIN_READ, PERMISSION_USER_TIER_WRITE},
    ADMIN_ROLE_BILLING: {PERMISSION_ADMIN_READ},
}
